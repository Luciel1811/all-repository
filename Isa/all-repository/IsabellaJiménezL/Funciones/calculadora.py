...
# s>= calculadora(number_1, number_2)#los valores se asignan en el orden que los opera la funcion
...
resultado = calculadora(number_1,number_2, operacion)#lo que devuelve la función se guarda aqui
# e aqui la diferencia entre usar el return o no usarlo
print(f"""
